...
<div class="container mt-5">
    ...
    <div class="row g-0">
        ...
        <div class="card-body p-4">
            <h1 class="display-1"><span class="text-danger">4</span><span class="text-primary">2</span><span class="text-success">9</span></h1>
            <h2 class="font-weight-bold display-4">Too Many Requests</h2>
