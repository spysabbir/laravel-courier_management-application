    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-info" id="changeStatus">Status Change Shipped</button>
            </div>
            <div class="card-body">
                <div class="filter">
                    <div class="row mb-3">
...
<script>
    $(document).ready(function(){
        ...
        $('#delivery_courier_data').DataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('delivery.courier.list.processing') }}",
                "data":function(e){
        ...
        $(document).on('click', '#changeStatus', function (e) {
            ...
            $.ajax({
                url: "{{ route('change.shipped.courier.status') }}",
                type: "POST",
                ...
                success: function (response) {
                    if(response.status == 400){
                        ...
                        toastr.success('Courier shipped successfully.');
                        $('#delivery_courier_data').DataTable().ajax.reload();
                    }
                },
            });
