    ...
    $(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 400) {
                        ...
                        $('#allDataTable').DataTable().ajax.reload();
                        toastr.success('Staff register successfully.');
                    }
                },
            });
        });
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 400) {
                        ...
                        $('#allDataTable').DataTable().ajax.reload();
                        toastr.success('Staff update successfully.');
                    }
                },
            });
        });
        ...
        $(document).on('click', '.statusBtn', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('#allDataTable').DataTable().ajax.reload();
                    toastr.success('Staff status change successfully.');
                },
            });
        });
        // View Data
