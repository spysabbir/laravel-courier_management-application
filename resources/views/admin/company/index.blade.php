                                ...
                                <form action="" method="POST" id="createForm" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="company_photo" class="form-control" id="image" accept=".jpeg, .jpg, .png, .webp, .svg">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="#" method="POST" id="editForm" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label>Company Photo</label>
                                                    <input type="file" name="company_photo" class="form-control" id="updateImage" accept=".jpeg, .jpg, .png, .webp, .svg">
